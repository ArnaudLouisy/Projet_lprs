    ...
    <?php else:?>
        <div class="container ">
            ...
            <form action="../traitement/action_utilisateur/action_admin/ajoutMateriele.php" method="post">
                ...
                <div class="mb-3 col-3">
                    <label for="exampleInputPassword1" class="form-label">Numerot serie</label>
                    <input type="number" name="numero_serie" class="form-control" id="exampleInputPassword1">
                </div>
                <div class="mb-3 col-3">
