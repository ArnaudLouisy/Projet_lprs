...
$evenementvalider = $evenement->voirLesEvenement($bdd);
$nombreevent = $evenement->nombreEvenement($bdd);
?>
<!doctype html>
                    ...
                    <div class="col-xl-6 col-lg-6">
                        <div class="right-caption">
                            ...
                            <div class="section-tittle section-tittle2">
                                <span> c'est quoi un evenement ? </span>
                                <h2>Des rencontres et des echange</h2>
                            </div>
                    ...
                    <div class="col-xl-9 col-lg-9 col-md-8">
                        ...
                        <section class="featured-job-area">
                            <div class="container">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="count-job mb-35">
                                            <span><?= $nombreevent[0] ?> Evenement trouvée</span>
                                            <!-- Select job items start -->
                                ...
                                <!-- single-job-content -->
                                <?php foreach ($evenementvalider as $value):?>
