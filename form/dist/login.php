  ...
  <body>
    <div class="main">
      <div class="container a-container" id="a-container">
          <form class="form" id="b-form" method="post" action="../../traitement/action_utilisateur/connection.php">
              ...
              if(isset($_SESSION['erreurconnexion'])):
                  echo ("<span class='form__span' style='color: red '>".$_SESSION['erreurconnexion']."</span>");
              else:
                  echo ("<span class='form__span'>ou adresse email pour vous connecter</span>");
              endif;
              ?>
      ...
      <div class="switch" id="switch-cnt">
        ...
        <div class="switch__container" id="switch-c1">
          ...
          <form><button formaction="inscription.php" class="switch__button button switch-btn">S'inscrire</button></form>
